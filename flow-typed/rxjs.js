...
declare type AjaxRequest = {
  ...
  responseType: string, // This is probably an enum, but not sure what the possible values are
  timeout: number,
  url: string,
  withCredentials: boolean,
};

declare type AjaxError = {
  message: string,
  request: AjaxRequest,
  status: number,
  xhr: XMLHttpRequest,
...
declare class rxjs$AjaxCreationMethod {
  static (urlOrRequest: string | AjaxRequest): rxjs$Observable<AjaxResponse<*>>;
...
declare class rxjs$Observable<+T> {
  static ajax: rxjs$AjaxCreationMethod;
